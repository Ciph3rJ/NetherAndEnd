...
public class NetherAndEndConfiguredFeatures {
    ...
    public static void boostrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> netherCoalOres = List.of(
                OreConfiguration.target(netherReplacables, NetherAndEndBlocks.NETHER_COAL_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> netherIronOres =
                List.of(OreConfiguration.target(netherReplacables, NetherAndEndBlocks.NETHER_IRON_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> netherCopperOres =
                List.of(OreConfiguration.target(netherReplacables, NetherAndEndBlocks.NETHER_COPPER_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> netherRedstoneOres =
                List.of(OreConfiguration.target(netherReplacables, NetherAndEndBlocks.NETHER_REDSTONE_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> netherEmeraldOres =
                List.of(OreConfiguration.target(netherReplacables, NetherAndEndBlocks.NETHER_EMERALD_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> netherLapisOres =
                List.of(OreConfiguration.target(netherReplacables, NetherAndEndBlocks.NETHER_LAPIS_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> netherDiamondOres =
                List.of(OreConfiguration.target(netherReplacables, NetherAndEndBlocks.NETHER_DIAMOND_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> crackedBedrock =
                List.of(OreConfiguration.target(bedrockReplacables, NetherAndEndBlocks.CRACKED_BEDROCK.defaultBlockState()));

        List<OreConfiguration.TargetBlockState> endCoalOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_COAL_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endIronOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_IRON_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endGoldOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_GOLD_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endCopperOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_COPPER_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endRedstoneOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_REDSTONE_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endEmeraldOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_EMERALD_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endLapisOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_LAPIS_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endDiamondOres =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.END_DIAMOND_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> enderPearlCluster =
                List.of(OreConfiguration.target(endReplacables, NetherAndEndBlocks.ENDER_PEARL_CLUSTER.defaultBlockState()));
    ...
    private static ResourceKey<ConfiguredFeature<?, ?>> register(String id) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(NetherAndEnd.MOD_ID, id));
    }
