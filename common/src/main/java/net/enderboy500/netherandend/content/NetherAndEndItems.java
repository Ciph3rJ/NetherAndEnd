...
public class NetherAndEndItems {
    ...
    public static final RegistryHandle<Item> SHULKER_FALCHION = Services.REGISTRY.registerItem("shulker_falchion", ShulkerFalchionItem::new);
    ...
    public static final RegistryHandle<Item> HARDENED_STRIDER_MEAT = Services.REGISTRY.registerItem("burnt_strider_meat", properties -> new Item(properties.food(NetherAndEndFoodComponents.HARDENED_STRIDER_MEAT, NetherAndEndConsumableComponents.HARDENED_STRIDER_MEAT).fireResistant()));
