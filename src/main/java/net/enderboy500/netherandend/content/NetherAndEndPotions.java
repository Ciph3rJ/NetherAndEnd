...
public class NetherAndEndPotions {
    ...
    public static final Holder<Potion> ENDERSIGHT_POTION = register("endersight_potion", new Potion("endersight",
            new MobEffectInstance(NetherAndEndEffects.INVERTED_VISION, 4800, 0)));
