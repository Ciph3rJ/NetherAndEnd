...
public class NetherAndEndItems {
    ...
    public static final Item CHORUS_SOUP = register("chorus_soup", Item::new, new Settings().food(NetherAndEndFoodComponents.CHORUS_SOUP).maxCount(1).useRemainder(Items.BOWL));
