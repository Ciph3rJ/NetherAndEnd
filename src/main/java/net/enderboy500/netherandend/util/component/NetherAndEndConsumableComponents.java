...
public class NetherAndEndConsumableComponents {
    ...
    public static final ConsumableComponent RAW_STRIDER_MEAT = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(new StatusEffectInstance(StatusEffects.POISON, 180, 0), 100)).consumeEffect(new ApplyEffectsConsumeEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 180, 0), 100)).build();
    public static final ConsumableComponent SMOKED_STRIDER_MEAT = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 180, 0), 100)).build();
    public static final ConsumableComponent HARDENED_STRIDER_MEAT = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 180, 0), 100)).build();
