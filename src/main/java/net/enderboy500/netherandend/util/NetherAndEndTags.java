...
public class NetherAndEndTags {
    public static TagKey<Block> CHORUS = TagKey.create(Registries.BLOCK, Identifier.parse(NetherAndEnd.MOD_ID).withPath("chorus"));
    ...
    public static TagKey<Item> REPAIRS_SHULKER_FALCHION = TagKey.create(Registries.ITEM, Identifier.parse(NetherAndEnd.MOD_ID).withPath("repairs_shulker_falchion"));
